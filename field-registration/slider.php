...
function gs_add_custom_slider_content_heading( $key, $prefix ) {
...
function gs_add_custom_content_slider_content_range( $key, $prefix ) {
	acf_add_local_field(array(
...
function gs_add_custom_content_slider_orphan_alignment( $key, $prefix ) {
